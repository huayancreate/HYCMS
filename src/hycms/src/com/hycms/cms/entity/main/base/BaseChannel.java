...
/**
 * This is an object that contains data related to the hy_channel table.
...
public abstract class BaseChannel  implements Serializable {
	...
	public BaseChannel (
		...
		com.hycms.cms.entity.main.CmsModel model,
	...
	// one to one
	private com.hycms.cms.entity.main.ChannelExt channelExt;

	// many to one
	private com.hycms.cms.entity.main.CmsSite site;
	private com.hycms.cms.entity.main.CmsModel model;
	private com.hycms.cms.entity.main.Channel parent;

	// collections
	private java.util.Set<com.hycms.cms.entity.main.Channel> child;
	private java.util.Set<com.hycms.cms.entity.main.CmsGroup> viewGroups;
	private java.util.Set<com.hycms.cms.entity.main.CmsGroup> contriGroups;
	private java.util.Set<com.hycms.cms.entity.main.CmsUser> users;
	private java.util.Set<com.hycms.cms.entity.main.ChannelTxt> channelTxtSet;
	 ...
	 */
	public com.hycms.cms.entity.main.ChannelExt getChannelExt () {
		return channelExt;
	}
	 ...
	 */
	public void setChannelExt (com.hycms.cms.entity.main.ChannelExt channelExt) {
	 ...
	 */
	public com.hycms.cms.entity.main.CmsModel getModel () {
		return model;
	}
	 ...
	 */
	public void setModel (com.hycms.cms.entity.main.CmsModel model) {
		this.model = model;
	}
	 ...
	 */
	public com.hycms.cms.entity.main.Channel getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.hycms.cms.entity.main.Channel parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.hycms.cms.entity.main.Channel> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.hycms.cms.entity.main.Channel> child) {
		this.child = child;
	}
	 ...
	 */
	public java.util.Set<com.hycms.cms.entity.main.CmsGroup> getContriGroups () {
		return contriGroups;
	}
	 ...
	 */
	public void setContriGroups (java.util.Set<com.hycms.cms.entity.main.CmsGroup> contriGroups) {
	 ...
	 */
	public java.util.Set<com.hycms.cms.entity.main.CmsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.hycms.cms.entity.main.CmsUser> users) {
		this.users = users;
	}
	 ...
	 */
	public java.util.Set<com.hycms.cms.entity.main.ChannelTxt> getChannelTxtSet () {
	 ...
	 */
	public void setChannelTxtSet (java.util.Set<com.hycms.cms.entity.main.ChannelTxt> channelTxtSet) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hycms.cms.entity.main.Channel)) return false;
		else {
			com.hycms.cms.entity.main.Channel channel = (com.hycms.cms.entity.main.Channel) obj;
