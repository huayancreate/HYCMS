...
/**
 * This is an object that contains data related to the hy_site table.
...
public abstract class BaseCmsSite  implements Serializable {
	...
	public BaseCmsSite (
		...
		com.hycms.cms.entity.main.CmsConfig config,
	...
	// many to one
	private com.hycms.core.entity.Ftp uploadFtp;
	private com.hycms.cms.entity.main.CmsConfig config;
	 ...
	 */
	public com.hycms.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (com.hycms.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.hycms.cms.entity.main.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.hycms.cms.entity.main.CmsConfig config) {
		this.config = config;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hycms.cms.entity.main.CmsSite)) return false;
		else {
			com.hycms.cms.entity.main.CmsSite cmsSite = (com.hycms.cms.entity.main.CmsSite) obj;
