...
/**
 * This is an object that contains data related to the hy_model table.
...
public abstract class BaseCmsModel  implements Serializable {
	...
	// collections
	private java.util.Set<com.hycms.cms.entity.main.CmsModelItem> items;
	 ...
	 */
	public java.util.Set<com.hycms.cms.entity.main.CmsModelItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.hycms.cms.entity.main.CmsModelItem> items) {
		this.items = items;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hycms.cms.entity.main.CmsModel)) return false;
		else {
			com.hycms.cms.entity.main.CmsModel cmsModel = (com.hycms.cms.entity.main.CmsModel) obj;
