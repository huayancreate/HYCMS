...
/**
 * This is an object that contains data related to the hy_vote_topic table.
...
public abstract class BaseCmsVoteTopic  implements Serializable {
	...
	// collections
	private java.util.Set<com.hycms.cms.entity.assist.CmsVoteItem> items;
	 ...
	 */
	public java.util.Set<com.hycms.cms.entity.assist.CmsVoteItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.hycms.cms.entity.assist.CmsVoteItem> items) {
		this.items = items;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hycms.cms.entity.assist.CmsVoteTopic)) return false;
		else {
			com.hycms.cms.entity.assist.CmsVoteTopic cmsVoteTopic = (com.hycms.cms.entity.assist.CmsVoteTopic) obj;
