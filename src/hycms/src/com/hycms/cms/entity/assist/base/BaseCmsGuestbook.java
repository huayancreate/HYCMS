...
/**
 * This is an object that contains data related to the hy_guestbook table.
...
public abstract class BaseCmsGuestbook  implements Serializable {
	...
	public BaseCmsGuestbook (
		...
		com.hycms.cms.entity.assist.CmsGuestbookCtg ctg,
		java.lang.String ip,
	...
	// one to one
	private com.hycms.cms.entity.assist.CmsGuestbookExt ext;

	// many to one
	private com.hycms.cms.entity.main.CmsUser member;
	private com.hycms.cms.entity.main.CmsUser admin;
	private com.hycms.cms.entity.main.CmsSite site;
	private com.hycms.cms.entity.assist.CmsGuestbookCtg ctg;
	 ...
	 */
	public com.hycms.cms.entity.assist.CmsGuestbookExt getExt () {
		return ext;
	}
	 ...
	 */
	public void setExt (com.hycms.cms.entity.assist.CmsGuestbookExt ext) {
		this.ext = ext;
	}
	 ...
	 */
	public com.hycms.cms.entity.main.CmsUser getMember () {
		return member;
	}
	 ...
	 */
	public void setMember (com.hycms.cms.entity.main.CmsUser member) {
		this.member = member;
	}
	 ...
	 */
	public com.hycms.cms.entity.main.CmsUser getAdmin () {
		return admin;
	}
	 ...
	 */
	public void setAdmin (com.hycms.cms.entity.main.CmsUser admin) {
		this.admin = admin;
	}
	 ...
	 */
	public com.hycms.cms.entity.assist.CmsGuestbookCtg getCtg () {
		return ctg;
	}
	 ...
	 */
	public void setCtg (com.hycms.cms.entity.assist.CmsGuestbookCtg ctg) {
		this.ctg = ctg;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hycms.cms.entity.assist.CmsGuestbook)) return false;
		else {
			com.hycms.cms.entity.assist.CmsGuestbook cmsGuestbook = (com.hycms.cms.entity.assist.CmsGuestbook) obj;
