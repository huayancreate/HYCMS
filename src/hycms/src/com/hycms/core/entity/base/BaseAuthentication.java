package com.hycms.core.entity.base;

import java.io.Serializable;


/**
 * This is an object that contains data related to the hyo_authentication table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="hyo_authentication"
 */
...
public abstract class BaseAuthentication  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hycms.core.entity.Authentication)) return false;
		else {
			com.hycms.core.entity.Authentication authentication = (com.hycms.core.entity.Authentication) obj;
