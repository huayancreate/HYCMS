...
<form action="install_setup.svl" method="post"
  ...
  <table width="980" border="0" align="center" cellpadding="0" cellspacing="0" class="rg-tbg">
    <tr>
      <td height="76" align="center"><h2>2、系统参数设置（环境要求：jdk1.5或以上、tomcat5.5或以上、oracle11g或以上）</h2>
		  ...
		  <table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td align="left"><input name="dbName" type="text" class="input"
					id="dbName" value="hycms_2012_sp1" /></td>
				<td align="left">&nbsp;</td>
			</tr>
			<tr>
...
<input type="hidden" name="dbFileName"
	value="/install/db/hycms-db-2012-sp1.sql" /><!--<input type="hidden"
	name="initFileName" value="/install/db/hycms-init-2012-sp1.sql" /> -->
</form>
</body>
</html>
